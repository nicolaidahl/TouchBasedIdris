...
\todo{Write about the dangers of massive untested changes, as well as structured vs. unstructured. Also mention "when to stop", i.e. should you stop with a tested design, but one that has known issues, or come up with a final design that fixes those issues, but is untested}
