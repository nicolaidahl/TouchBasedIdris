...
\todo{Kan vi gøre usability lyd-filerne tilgængelige, så vi kan referere til
dem?}
...
\todo{Er det bare mig eller ser fonten anderledes ud i den her liste?}
...
text already has an action associated with it. \\ \\ \todo{Det mindes jeg ikke det her}
...
\todo{Et af de større problemer jeg husker er undo/redo knapperne}
