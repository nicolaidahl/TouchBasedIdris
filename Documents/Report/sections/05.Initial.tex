...
Undo and redo support is implemented as two buttons in the toolbar.
...
To be able to declare function types quickly, it was paramount that the interface intelligently presented terms the user might have use of.
...
When filling in a type, a popover with suggestions appears. In our mock-up,
...
But before we can do this, we need to lay some technical groundwork, which is described in the next section.
